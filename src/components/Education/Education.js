    ...
    <Section id='education'>
      ...
      <ListItem>
        ...
        <ListContainer>
          ...
          <ListParagraph>
            A 16 week intense coding bootcamp in London. The course focused on teaching students how to set themselves up to learn and develop their programming skills, alongside how to work with others inside an Agile work environment<br/>
          </ListParagraph>
        </ListContainer>
      </ListItem>
      <ListItem>
